...
[![See it on NPM!](https://img.shields.io/npm/v/@aurodesignsystem/auro-counter?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@aurodesignsystem/auro-counter)
[![License](https://img.shields.io/npm/l/@aurodesignsystem/auro-counter?color=blue&style=for-the-badge)](https://www.apache.org/licenses/LICENSE-2.0)

```shell
$ npm i @aurodesignsystem/auro-counter
```
...
```js
import "@aurodesignsystem/auro-counter";
```
...
<script src="https://unpkg.com/@aurodesignsystem/auro-counter@latest/dist/auro-counter__bundled.js" type="module"></script>
<script src="https://unpkg.com/@aurodesignsystem/auro-counter@latest/dist/auro-counter__bundled.es5.js" nomodule></script>
```
