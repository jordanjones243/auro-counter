...
title: 'auro-counter: [vX.X-rc]'
labels: release
assignees: braven112
---

The following items are to be included with the next feature release of the `auro-counter`, all PRs are to be from the feature branch to `vX.X-rc` branch.
